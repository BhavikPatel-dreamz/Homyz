  ...
  if (error || !resolution) {
    return (
      <div className="rounded-2xl border border-rose-200 bg-rose-50 dark:bg-rose-950/40 dark:border-rose-900/50 p-6 text-xs text-rose-800 dark:text-rose-300 space-y-3">
        <strong className="block text-sm font-semibold">Failed to load permissions</strong>
        <p>{error || "Unable to fetch host permission resolution."}</p>
        <button
          onClick={loadData}
          className="rounded-full bg-rose-600 px-4 py-2 text-xs font-semibold text-white shadow-2xs hover:bg-rose-700 transition-all"
        >
          Retry
        </button>
      </div>
    ...
    <div className="flex flex-col gap-6 font-sans text-muted-foreground">
      ...
      {isSuspended && (
        <div className="rounded-2xl border border-amber-200 bg-amber-50/90 dark:bg-amber-950/40 dark:border-amber-900/50 p-4 text-xs text-amber-900 dark:text-amber-300 flex items-start gap-3 shadow-2xs">
          ...
          <div>
            <strong className="block font-semibold text-muted-foreground">Host Account is SUSPENDED</strong>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-2xs">
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <span className="text-2xl font-semibold tracking-tight text-blue-600 dark:text-blue-400">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-2xs">
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <span className="text-2xl font-semibold tracking-tight text-rose-600 dark:text-rose-400">
      ...
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-2xs space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[var(--border-subtle)] pb-5">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {hasUnsavedChanges && (
              <span className="text-xs font-semibold text-amber-800 bg-amber-50 dark:bg-amber-950/50 dark:text-amber-300 px-3 py-1.5 rounded-full border border-amber-200 dark:border-amber-800 animate-pulse">
            ...
            <button
              ...
              disabled={isPending}
              className="rounded-full border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-xs font-semibold text-muted-foreground hover:bg-[var(--surface-secondary)] transition-all inline-flex items-center gap-2 disabled:opacity-50 shadow-2xs"
            >
              {isPending && (
            ...
            <button
              ...
              className={`rounded-full px-5 py-2 text-xs font-semibold transition-all shadow-2xs inline-flex items-center gap-2 ${
                hasUnsavedChanges
          ...
          <div className="flex items-center justify-between gap-4 p-3 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900/50 rounded-2xl text-xs">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-1.5 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold transition-all shadow-2xs"
              >
                Allow Selected
              </button>
              <button
                ...
                className="px-3 py-1.5 rounded-full bg-rose-600 hover:bg-rose-700 text-white font-semibold transition-all shadow-2xs"
              >
                Deny Selected
              </button>
              <button
                ...
                className="px-3 py-1.5 rounded-full bg-zinc-700 hover:bg-zinc-800 text-white font-semibold transition-all shadow-2xs"
              >
                Reset to Inherited
              </button>
              <button
                ...
                className="text-[var(--muted-foreground)] hover:text-muted-foreground text-xs underline ml-2 font-semibold"
              >
                Deselect
              </button>
            </div>
                ...
                filteredPermissions.map((perm) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4 align-middle">
                        <div className="flex items-center gap-2 flex-wrap">
                          <span className="font-semibold text-muted-foreground">{perm.label}</span>
                          ...
                          {isStagedChanged && (
                            <span className="text-[10px] font-semibold text-amber-800 bg-amber-100 dark:bg-amber-950/60 dark:text-amber-300 px-2 py-0.5 rounded-full border border-amber-200 dark:border-amber-800">
                              Modified
                            </span>
                          )}
                        </div>
