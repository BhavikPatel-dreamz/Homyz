...
export const secondaryButtonClass =
  "inline-flex items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface)] px-5 py-2.5 text-xs font-bold text-muted-foreground hover:bg-[var(--muted)] transition-colors disabled:opacity-50 cursor-pointer shadow-2xs";
