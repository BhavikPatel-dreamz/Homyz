          ...
          <div className="flex items-center justify-center gap-2 mb-2 w-full">
            {isEditing ? (
              <div className="flex items-center justify-center gap-1 border-b-2 border-zinc-900 pb-1">
                <span className="text-3xl sm:text-4xl font-extrabold text-zinc-900">{currencySymbol}</span>
                <input
                  type="number"
                  min={10}
                  max={500000}
                  ...
                  autoFocus
                  className="text-3xl sm:text-4xl font-extrabold text-zinc-900 bg-transparent outline-none w-32 text-center"
                />
              </div>
            ) : (
              <button
                ...
                className="group flex items-center justify-center gap-2 text-4xl sm:text-5xl font-extrabold text-zinc-900 tracking-tight hover:opacity-80 transition-opacity cursor-pointer"
              >
                <span>
                  {currencySymbol}
