              ...
              {placeTypes.map((pt) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-start justify-between p-6 sm:p-7 rounded-3xl border transition-all text-left cursor-pointer group ${isSelected
                  ...
                  >
                    ...
                    <svg
                      className={`w-5 h-5 shrink-0 mt-2 transition-colors ${isSelected ? "text-indigo-600" : "text-zinc-400 group-hover:text-zinc-700"
                        }`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
