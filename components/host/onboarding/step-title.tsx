...
export function StepTitle({
  ...
  return (
    <OnboardingStepLayout
      isLoading={isLoading}
      mainClassName="step-title min-h-dvh bg-white pb-8 sm:py-12 lg:pt-25 lg:pb-16"
    ...
    >
      ...
      <StepProgressFooter currentStep={4} totalSteps={6} onBack={onBack} onNext={onNext} isLoading={isLoading} />
    </OnboardingStepLayout>
  );
}
