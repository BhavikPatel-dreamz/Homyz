        ...
        <div className="border-t border-[rgba(31,31,31,0.9)] pt-8 sm:pt-12 pb-6">
          ...
          <div className="relative grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col">
              <h4 className="text-base font-medium text-[#1F1F1F] sm:text-lg mb-6">
                Support
              </h4>
              <ul className="flex flex-col space-y-3">
                <li>
                  <Link href="#" className="text-base leading-6 text-[#000000] underline hover:text-[#727272] transition">
                    Help Center
                  </Link>
                </li>
                <li>
            ...
            <div className="flex flex-col relative">
              ...
              <div className="inline-flex items-center w-auto max-w-auto space-x-6 mt-9 py-4 border-t-2 border-[#1f1f1f]">
