...
const baseClass = "box-border inline-flex items-center justify-center gap-2 rounded-full font-sans font-medium text-[#1F1F1F] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E3CFFC] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60";
export const primaryButtonInteractionClass = "hover:bg-[#1F1F1F] hover:text-white active:bg-[#1F1F1F] active:text-white";

const variantClasses: Record<ButtonVariant, string> = {
  primary: `min-h-12 bg-[#FCDF9C] px-6 py-3 text-base leading-6 ${primaryButtonInteractionClass}`,
