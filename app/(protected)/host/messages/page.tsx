...
export default async function HostMessagesPage() {
  ...
  return (
    <div className="min-h-screen pb-[calc(110px+env(safe-area-inset-bottom))] sm:pb-0 bg-white text-[#1F1F1F] font-sans flex flex-col selection:bg-[#FEE08B] selection:text-[#1F1F1F]">
      {/* TOP HEADER */}
      <HostHeader />
