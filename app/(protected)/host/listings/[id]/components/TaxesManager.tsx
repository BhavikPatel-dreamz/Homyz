          ...
          >
            ...
            <div className="border-t border-[#E5E5E5] dark:border-zinc-800 px-6 sm:px-8 lg:px-10 py-4 bg-white dark:bg-zinc-900 flex items-center justify-between sticky bottom-0 z-10">
              <button
                type="button"
                onClick={handleCancel}
                className="text-xs font-semibold text-zinc-900 dark:text-zinc-300 underline hover:text-black dark:hover:text-white cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                onClick={() => handleSave()}
                disabled={isSaving}
                className="px-6 py-2.5 rounded-lg text-xs font-semibold bg-black dark:bg-zinc-100 text-white dark:text-zinc-900 hover:bg-zinc-800 dark:hover:bg-zinc-200 disabled:bg-zinc-200 dark:disabled:bg-zinc-800 disabled:text-zinc-400 dark:disabled:text-zinc-600 disabled:cursor-not-allowed transition-colors cursor-pointer"
              >
          ...
          <div className="w-full max-w-sm bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-2xl animate-in fade-in zoom-in-95">
            ...
            <div className="mt-6 flex items-center justify-end gap-3">
              <button
                ...
                className="px-4 py-2 border border-zinc-300 dark:border-zinc-700 rounded-lg text-xs font-semibold text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 cursor-pointer"
              >
                Cancel
              </button>
              <button
