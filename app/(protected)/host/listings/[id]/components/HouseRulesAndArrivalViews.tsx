        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start pt-2">
          ...
          <div className="md:col-span-7 space-y-6">
            ...
            <div className="space-y-4 pt-3">
              ...
              {isEditingReg ? (
                <div className="space-y-4 pt-4 max-w-md bg-zinc-50 dark:bg-zinc-800 p-4 rounded-lg border border-[#727272] dark:border-zinc-700">
                  <div>
                    <label className="text-base font-normal text-[#1f1f1f] dark:text-zinc-300 block mb-1">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg border border-[#727272] dark:border-zinc-600 text-xs font-semibold text-[#1F1F1F] dark:text-zinc-100 focus:outline-none focus:border-zinc-500 bg-white sm:min-h-[56px] min-h-[45px] dark:bg-zinc-900"
                    />
                  </div>
                  <div>
                    <label className="text-base font-normal text-[#1f1f1f] dark:text-zinc-300 block mb-1">
