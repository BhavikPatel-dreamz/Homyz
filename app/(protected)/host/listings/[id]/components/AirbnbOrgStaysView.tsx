...
export function AirbnbOrgStaysView({
  ...
  return (
    <div className="max-w-2xl font-sans animate-in fade-in duration-200 pb-10 text-[#222222] dark:text-zinc-100">
      {/* 1. Page Title */}
      <div className="mb-6">
        <h1 className="text-2xl sm:text-[32px] font-bold tracking-tight text-[#222222] dark:text-zinc-100 leading-tight">
          Homyz.com Stays
        </h1>
      ...
      <div className="mb-6 p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 space-y-2 text-xs sm:text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
        <p>
      ...
      <div className="pt-2 pb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-100 dark:border-zinc-800">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <h2 className="text-lg sm:text-xl font-bold text-[#1F1F1F] dark:text-zinc-100 tracking-tight leading-none">
              Homyz.com Stays
            </h2>
            <span
          ...
          <p className="text-xs text-[#E01563] dark:text-rose-400 font-semibold tracking-tight pt-0.5">
            Homyz.org
          </p>
      ...
      {isEnabled && (
        <div className="my-6 p-5 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/60 space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
          <p className="text-xs font-semibold text-zinc-900 dark:text-zinc-100 tracking-wide uppercase">
              ...
              <div className="text-xs flex-1">
                ...
                {discountType === "DISCOUNT" && (
                  <div className="mt-3.5 pt-3 border-t border-zinc-100 dark:border-zinc-800 flex flex-wrap items-center gap-2">
                    <span className="text-xs text-zinc-700 dark:text-zinc-300 font-medium mr-1">
                      Discount percentage:
                    </span>
                    {[20, 30, 50].map((pct) => (
                      <button
                    ...
                    <div className="flex items-center gap-1.5 ml-auto">
                      <input
                        ...
                        className="w-14 px-2 py-1 text-xs border border-zinc-300 dark:border-zinc-700 rounded-md text-center font-semibold text-zinc-900 dark:text-zinc-100 bg-white dark:bg-zinc-800"
                      />
      ...
      <div className="mt-10 pt-2 space-y-4">
        <h3 className="text-base sm:text-[18px] font-bold text-[#222222] dark:text-zinc-100 tracking-tight">
        ...
        <div className="pt-2 flex flex-wrap items-center gap-4">
          <button
            ...
            className="text-xs sm:text-sm font-normal text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200 hover:underline cursor-pointer inline-flex items-center gap-1"
          >
      ...
      <div className="flex flex-wrap items-center gap-3 pt-8 border-t border-zinc-100 dark:border-zinc-800">
        ...
        <button
          ...
          className="rounded-full bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 font-semibold text-xs px-7 py-2.5 shadow-2xs transition-all cursor-pointer"
        >
          Cancel
        </button>
        ...
        {saveError && <p role="alert" className="text-xs font-medium text-rose-600 dark:text-rose-400">{saveError}</p>}
      </div>
        ...
        >
          ...
          >
            ...
            <div className="sticky top-0 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-sm z-20 border-b border-zinc-100 dark:border-zinc-800 px-6 py-4 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-rose-50 dark:bg-rose-950/40 text-[#E01563] dark:text-rose-400 border border-rose-200 dark:border-rose-900/60">
                  Resource Centre
                </span>
                <span className="text-xs text-zinc-400">·</span>
                <span className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">3 min read</span>
              </div>
              <button
                type="button"
                onClick={() => setIsLearnMoreOpen(false)}
            ...
            <div className="p-6 sm:p-8 space-y-6 overflow-y-auto flex-1 text-zinc-800 dark:text-zinc-200 text-sm leading-relaxed">
              ...
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-xs font-semibold text-[#E01563] dark:text-rose-400 hover:underline"
                >
            ...
            <div className="p-4 sm:px-6 border-t border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 flex items-center justify-end shrink-0">
              <button
                type="button"
                onClick={() => setIsLearnMoreOpen(false)}
                className="px-6 py-2.5 rounded-full bg-zinc-900 hover:bg-black dark:bg-zinc-100 dark:hover:bg-zinc-200 text-white dark:text-zinc-900 text-xs font-semibold cursor-pointer transition-colors shadow-2xs"
              >
                Done
              </button>
            </div>
