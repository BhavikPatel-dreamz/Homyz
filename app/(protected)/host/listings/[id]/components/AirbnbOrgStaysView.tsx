...
export function AirbnbOrgStaysView({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error("Failed to save Airbnb.org stays preferences:", e);
    }
  };
  ...
  return (
    <div className="max-w-2xl font-sans animate-in fade-in duration-200 pb-28 text-[#222222]">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="text-xs flex-1">
                ...
                <span className="text-zinc-500 font-normal leading-relaxed block mt-0.5">
                  Offer a discount off your standard nightly rate for verified Airbnb.org bookings.
                </span>
      ...
      {/* 3. "How Airbnb.org stays work" Section */}
      <div className="mt-10 pt-2 space-y-4">
        ...
        <ul className="space-y-4 text-sm text-[#222222] font-normal leading-relaxed list-none pl-0">
          ...
          <li className="flex items-start gap-2.5">
            <span className="text-zinc-800 text-base leading-none select-none mt-1">•</span>
            <span>
              Airbnb.org or its partner checks guests&apos; eligibility.
            </span>
          </li>
          <li className="flex items-start gap-2.5">
            <span className="text-zinc-800 text-base leading-none select-none mt-1">•</span>
            <span>
              Airbnb.org&apos;s partners may send requests on behalf of their clients.
            </span>
          </li>
          <li className="flex items-start gap-2.5">
            <span className="text-zinc-800 text-base leading-none select-none mt-1">•</span>
        ...
        {/* 4. "Learn more about Airbnb.org >" Link */}
        <div className="pt-2">
          <button
            type="button"
          ...
          >
            <span>Learn more about Airbnb.org</span>
      ...
      {/* 5. Fixed Bottom Right Save Button (Matches Airbnb UI exactly) */}
      ...
      {/* 6. Slide-Over Drawer for "Learn more about Airbnb.org" (AGENTS.md ModalOverlay Compliant) */}
      {isLearnMoreOpen && (
        <ModalOverlay
            ...
            <div className="p-6 sm:p-8 space-y-6 overflow-y-auto flex-1 text-zinc-800 text-sm leading-relaxed">
              <div>
                <h2 className="text-2xl font-bold text-zinc-950 tracking-tight">
                  About Airbnb.org and emergency stays
                </h2>
              ...
              <div className="p-4 rounded-xl bg-zinc-50 border border-zinc-200 space-y-2">
                <div className="flex items-center gap-2 text-zinc-950 font-semibold">
                  ...
                  <h4>What is Airbnb.org?</h4>
                </div>
                <p className="text-xs text-zinc-600 leading-relaxed">
                  Airbnb.org is an independent nonprofit organization that connects people in crisis with temporary emergency housing provided by hosts and funded by donors.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-zinc-50 border border-zinc-200 space-y-2">
                <div className="flex items-center gap-2 text-zinc-950 font-semibold">
                  ...
                  <h4>Who stays with Airbnb.org?</h4>
                </div>
                <p className="text-xs text-zinc-600 leading-relaxed">
              ...
              <div className="p-4 rounded-xl bg-zinc-50 border border-zinc-200 space-y-2">
                ...
                <p className="text-xs text-zinc-600 leading-relaxed">
                  Airbnb.org works with established humanitarian organizations such as the International Rescue Committee (IRC), CORE, and GlobalGiving. These organizations assess guest eligibility and frequently manage reservations on behalf of their clients.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-zinc-50 border border-zinc-200 space-y-2">
                ...
                <p className="text-xs text-zinc-600 leading-relaxed">
                  Every Airbnb.org stay includes comprehensive Host damage protection up to $1,000,000 USD and liability insurance, giving you total peace of mind whenever you host.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-zinc-50 border border-zinc-200 space-y-2">
                ...
                <p className="text-xs text-zinc-600 leading-relaxed">
                  You are always in control. You review each Airbnb.org stay request individually before accepting. If you are unable to accommodate a request, declining will never affect your Superhost status or search performance.
                </p>
              </div>
              ...
              <div className="pt-2">
                ...
                >
                  <span>Visit official Airbnb.org website</span>
