            ...
            {TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-4 px-4 py-3 rounded-xl transition-all text-left font-medium text-sm ${active ? "bg-[#FDE29B] text-zinc-900 font-semibold shadow-sm" : "text-zinc-700 hover:bg-zinc-50"
                    }`}
                >
                  {tab.id === 'about' ? (
        ...
        <div className="mt-4 pt-4">
          <div className="flex items-center justify-between mb-1">
            ...
            <div
              ...
              className={`w-11 h-6 rounded-full relative cursor-pointer transition-colors ${formDataState.stampsVisible ? "bg-[#FA595D]" : "bg-zinc-300"
                }`}
            >
              <div className={`w-5 h-5 bg-white rounded-full absolute top-0.5 transition-transform shadow-xs ${formDataState.stampsVisible ? "right-0.5" : "left-0.5"
                }`}></div>
            </div>
          </div>
